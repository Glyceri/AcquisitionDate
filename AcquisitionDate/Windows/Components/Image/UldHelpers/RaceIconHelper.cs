...
namespace AcquistionDate.PetNicknames.Windowing.Components.Image.UldHelpers;
...
internal static class RaceIconHelper
{
    ...
    {
        TierIcon = TextureLoader.LoadUld("ui/uld/LovmActionDetail.uld", 3, 0);
        ApparatIcon = TextureLoader.LoadUld("ui/uld/LovmActionDetail.uld", 3, 1);
        PuppeIcon = TextureLoader.LoadUld("ui/uld/LovmActionDetail.uld", 3, 2);
        MonsterIcon = TextureLoader.LoadUld("ui/uld/LovmActionDetail.uld", 3, 3);
    }
