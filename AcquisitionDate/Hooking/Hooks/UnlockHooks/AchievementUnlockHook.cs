...
internal unsafe class AchievementUnlockHook : UnlockHook
{
    ...
    public AchievementUnlockHook(IUserList userList, IDirtyListener dirtyListener) : base(dirtyListener, userList) { }
    ...
    public override void OnUpdate(float deltaTime) { } // No Update needed for achievements due to the direct hook.
}
