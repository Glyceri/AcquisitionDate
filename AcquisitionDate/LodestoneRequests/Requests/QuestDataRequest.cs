...
internal class QuestDataRequest : CharacterRequest
{
    ...
    public QuestDataRequest(QuestListParser questListParser, QuestDataParser questDataParser, IDatableData data, int page, Action<QuestData> continuousSuccessCallback, System.Action? successCallback = null, Action<Exception>? failureCallback = null) : base(data)
    {
